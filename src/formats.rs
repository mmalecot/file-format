...
formats! {
    ...
    extension = ["abw", "abw.CRASHED", "abw.gz", "abwa", "zabw"]
    kind = Document
    ...
    extension = ["bdm", "bdmv", "clpi", "cpi", "m2t", "m2ts", "mpl", "mpls", "mts", "ts"]
    kind = Video
    ...
    extension = ["comdir", "dcm", "dic", "dicom"]
    kind = Other
    ...
    extension = ["cls", "dtx", "ins", "latex", "ltx", "sty", "tex"]
    kind = Document
    ...
    extension = ["xla", "xlc", "xld", "xll", "xlm", "xlr", "xls", "xlt", "xlw"]
    kind = Spreadsheet
    ...
    extension = ["evo", "mp2", "mpe", "mpeg", "mpg", "vdr", "vob"]
    kind = Video
    ...
    extension = ["asc", "gpg", "key", "pgp", "pkr", "skr"]
    kind = Other
    ...
    extension = ["rm", "rmj", "rmm", "rms", "rmvb", "rmx"]
    kind = Other
    ...
    short_name = "MQV"
    media_type = "video/quicktime"
    extension = ["moov", "mov", "mqv", "qt", "qtvr"]
    kind = Video
    ...
    extension = ["669", "m15", "med", "mod", "mtm", "ult", "uni"]
    kind = Audio
    ...
    extension = ["wp", "wp4", "wp5", "wp6", "wpd", "wpp"]
    kind = Document
    ...
    short_name = "WPG"
    media_type = "application/vnd.wordperfect"
    extension = ["wp", "wp4", "wp5", "wp6", "wpd", "wpg", "wpp"]
    kind = Image
    ...
    short_name = "WPM"
    media_type = "application/vnd.wordperfect"
    extension = ["wp", "wp4", "wp5", "wp6", "wpd", "wpm", "wpp"]
    kind = Other
    ...
    short_name = "SHW"
    media_type = "application/vnd.wordperfect"
    extension = ["shw", "wp", "wp4", "wp5", "wp6", "wpd", "wpp"]
    kind = Presentation
