...
fn test_aif() {
    ...
    assert_eq!(format.preferred_extension(), Some("aif"));
}
...
fn test_au() {
    ...
    assert_eq!(format.preferred_extension(), Some("au"));
}
...
fn test_flac() {
    ...
    assert_eq!(format.preferred_extension(), Some("flac"));
}
...
fn test_m4a() {
    ...
    assert_eq!(format.preferred_extension(), Some("m4a"));
}
...
fn test_mp3() {
    ...
    assert_eq!(format.preferred_extension(), Some("mp3"));
}
...
fn test_oga() {
    ...
    assert_eq!(format.preferred_extension(), Some("ogg"));
}
...
fn test_wav() {
    ...
    assert_eq!(format.preferred_extension(), Some("wav"));
}
...
fn test_wc() {
    ...
    assert_eq!(format.preferred_extension(), Some("wv"));
}
