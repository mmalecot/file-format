...
fn test_avi() {
    ...
    assert_eq!(format.preferred_extension(), Some("avi"));
}
...
fn test_mkv() {
    ...
    assert_eq!(format.preferred_extension(), Some("mkv"));
}
...
fn test_mov() {
    ...
    assert_eq!(format.preferred_extension(), Some("mov"));
}
...
fn test_ogv() {
    ...
    assert_eq!(format.preferred_extension(), Some("ogv"));
}
...
fn test_webm() {
    ...
    assert_eq!(format.preferred_extension(), Some("webm"));
}
...
fn test_wmv() {
    ...
    assert_eq!(format.preferred_extension(), Some("wmv"));
}
